...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('mod_unlock')
    .setDescription('Unlock Release/Cancel buttons for a deal (Owner Only)')
  ...
  async execute(interaction) {
    ...
    db.updateDeal(deal.deal_id, { buttons_locked: 0 });
    await interaction.reply({ embeds: [successEmbed('Deal Unlocked', `Release/Cancel buttons for **${deal.deal_id}** are now active.`)] });
  },
};
